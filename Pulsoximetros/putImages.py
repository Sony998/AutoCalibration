...
def main(excel_file):
    ...
    def agregar_imagenes_pdf1(fondo_path, output_pdf_path, nombrecertificado, fecha):
        ...
        c.setFont("Arial", 12)
        c.drawString(315, 292, fecha)
        c.drawString(315, 270, fecha)
        c.setFont("Arial", 10)
        c.drawString(310, 246, nombreEse)
        c.setFont("Arial", 12)
        c.drawString(315, 226, metrologo)
        c.setFont("ArialI", 14)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Process Excel file for AutoCalibration.")
    parser.add_argument("--f", required=True, help="Path to the Excel file")
