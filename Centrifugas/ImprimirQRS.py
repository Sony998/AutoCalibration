...
def generate_pdf_from_images():
    ...
    directories = ['OUTPUT/QRS','/home/raven/Proyects/AutoCalibration/Serologico/OUTPUT/QRS','/home/raven/Proyects/AutoCalibration/Rotador/OUTPUT/QRS' ]
    output_pdf = 'OUTPUT/Imprimir/QRSCentrifugas.pdf'
