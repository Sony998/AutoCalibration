...
def crear_paginas(archivo_excel):
    ...
    for certificado in certificados:
        print(certificado)
        output_pdf_path = output_directory1 + certificado + ".pdf"        
        agregar_imagenes_pdf1(img_fondo_path1, output_pdf_path , certificado, metrologo, fecha, ubicacion, temperaturaminima, temperaturamaxima, humedadminima, humedadmaxima, presionbarometrica)
        output_pdf_path = output_directory2 + certificado + ".pdf"
        ...
        agregar_imagenes_pdf2(img_fondo_path2, output_pdf_path, ecg_list[errorpos], fdepulso_list[errorpos], diastolica_list[errorpos], sistolica_list[errorpos], saturacion_list[errorpos], fp_list[errorpos], respiracion_list[errorpos])
        output_pdf_path = output_directory3 + certificado + ".pdf"
        agregar_imagenes_pdf3(img_fondo_path3, imagen_error_sistolica, imagen_desviacion_sistolica, output_pdf_path, yinferior=60, ysuperior=410)
        output_pdf_path = output_directory4 + certificado + ".pdf"
        ...
        agregar_imagenes_pdf4(img_fondo_path4, imagen_error_diastolica, imagen_desviacion_diastolica, output_pdf_path, yinferior=60, ysuperior=410)
        ...
        output_pdf_path = output_directory5 + certificado + ".pdf"
        agregar_imagenes_pdf5(img_fondo_path5, imagen_error_frecuencia, imagen_desviacion_frecuencia, output_pdf_path, yinferior=60, ysuperior=410)
        ...
        output_pdf_path = output_directory6 + certificado + ".pdf"
        agregar_imagenes_pdf6(img_fondo_path6, imagen_error_saturacion, imagen_desviacion_saturacion, output_pdf_path, yinferior=60, ysuperior=410)
        output_pdf_path = output_directory7 + certificado + ".pdf"
        agregar_imagenes_pdf7(img_fondo_path7, output_pdf_path, notas[errorpos])
        errorpos += 1



def agregar_imagenes_pdf1(fondo_path, output_pdf_path, nombrecertificado, metrologo, fecha, ubicacion, temperaturaminima, temperaturamaxima, humedadminima, humedadmaxima, presionbarometrica):
