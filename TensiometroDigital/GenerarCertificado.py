...
def main():
    parser = argparse.ArgumentParser(description='Generar certificados a partir de un archivo Excel.')
    parser.add_argument('--f', required=True, help='Ruta al archivo Excel')
